# Projeto 8 - Ajuste Fino com Nossos Próprios Dados e Deploy de LLM via App Web
...
conda create --name dsallmp8 python=3.12

### Ative o ambiente:

conda activate dsallmp8 (ou: source activate dsallmp8)
...
conda deactivate
conda remove --name dsallmp8 --all
